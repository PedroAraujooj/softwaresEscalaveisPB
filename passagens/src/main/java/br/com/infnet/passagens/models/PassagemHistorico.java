...
public class PassagemHistorico {
    ...
    @Column(name = "passageiro_nome", nullable = false, length = 120)
    ...
    public static PassagemHistorico registrar(
            Passagem passagem,
        ...
        historico.setPassageiroId(passagem.getPassageiroId());
        historico.setPassageiroNome(passageiroNome);
